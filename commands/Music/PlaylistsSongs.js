    ...
    async execute(client, message, args) {
        ...
        const User = await Playlist.findOne({
            ...
            if (!user) {
                ...
                return message.channel.send('This user was not in our database! We have added it, please retype this command.');
            }
        });
        ...
        const b = await message.channel.send(new MessageEmbed().setDescription(StringHolder).setTitle("Your Playlists").setFooter("Please enter the playlist from which you'd like to display the songs."))
        ...
        await b.channel.awaitMessages(m => m.author.id === message.author.id,
            ...
            return message.channel.send(new MessageEmbed().setDescription(StringHolder).setTitle("Your Songs"))
    }

...
module.exports = {
    ...
    execute(client, message) {
        ...
        message.channel.send(new Discord.MessageEmbed().setDescription(`${client.emotes.success} - Music Skipped ! \n \n Skipped by: **${message.author.username}**`).setTitle("**Skipped!**"));

        }catch(e){

            return message.channel.send(new Discord.MessageEmbed().setDescription(":x: An error occiered when executing the command | Retry once the current track has started!"))

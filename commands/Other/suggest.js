...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if (SuggestionChannelGuild === "None") {
            ...
            message.channel.send((new Discord.MessageEmbed().setTitle("**Sent!**").setDescription("Your suggestion has properly been sent! Thank you for suggesting. We will review your suggestion!")))
        } else {

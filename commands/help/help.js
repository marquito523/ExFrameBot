...
module.exports = {
    ...
    async execute(client, message) {
        ...
        }else if(message.content === `${prefix}help article list`)

        var embed = new Discord.MessageEmbed()
        .setTitle('** ExFrame Help Article**')
        .setURL("https://marcoaskovic.wixsite.com/exframe")
        .setTimestamp()
        .addFields(


            { name: '**Entries** Allows you to enter balance games', value: "`Do " + prefix + "buy entries [Amount]`", inline: true },
            { name: '\u200B', value: '\u200B', inline: true },
            { name: '**Soon**', value: "`Do " + prefix + "N/A`", inline: true },

...
module.exports = {
    ...
    async execute(client, message,args){
        ...
        const UserData = db.get(`user_${message.author.id}_wins`) || 0
        ...
        const UserWon = UserData + 1
            ...
            try{
                ...
                db.set(`User_${message.author.id}_GameEntries`, UserEntries - 1)
    ...
    //channel.send(`Bienvenue ${member} !`, attachment);
        ...
        await b.channel.awaitMessages(m => m.author.id === message.author.id,
            ...
            try{
                ...
                db.set(`user_${message.author.id}_win`, UserWon)

                db.set(`User_${message.author.id}_Framits`, UserCurrencyWon)

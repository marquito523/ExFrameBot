...
module.exports = {
  ...
  execute(client, message, args) {
    ...
    if (user) {
      ...
      if(user.id === message.author.id)return message.channel.send(new Discord.MessageEmbed().setDescription("You want to kick yourself..? No, you just can't to that. We **need** you here. I'm kicking an awesome person like you.").setTitle("Kicking Yourself").setFooter("Come on, we need you here!"))

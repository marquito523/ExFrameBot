...
module.exports = {
    ...
    async execute(client, message) {
        ...
        if (message.content === `${prefix}help`) {
            ...
            .addField(`Add Filter`, `Adds a filter. Usage: ${prefix}addfilter`)
        ...
        const utility = new Discord.MessageEmbed()
            ...
            .addField(`Create Playlist <BETA>`, `Creates are playlist. Usage: ${prefix}createplaylist`)
            .addField(`Add Song (Playlist) <BETA>`, `Adds your song to a playlist. Usage: ${prefix}addtoplaylist`)

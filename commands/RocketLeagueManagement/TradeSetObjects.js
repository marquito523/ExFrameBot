        ...
        await b.channel.awaitMessages(m => m.author.id === message.author.id,
            ...
            if(Exc === 1){
                ...
                await L.channel.awaitMessages(m => m.author.id === message.author.id,
                    ...
                    if(timevar === Slot1Containing ||timevar === Slot2Containing || timevar === Slot3Containing )return message.channel.send(new MessageEmbed().setDescription(`Seems like you already are trading this item on once of your slots. Please change it.`))

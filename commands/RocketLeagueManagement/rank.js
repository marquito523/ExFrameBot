...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if (timevar === 'yes') {
            ...
            if(ChosenRank === undefined || !ChosenRank)return message.channel.send(new MessageEmbed().setDescription("Unexpected reply!"))
            try {
            ...
            return message.channel.send(new MessageEmbed().setDescription("Process Ended."))
        }
    }
}
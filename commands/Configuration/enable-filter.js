...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if (!settings.CustomFilterWords || settings.CustomFilterWords === [] || settings.CustomFilterWords.length === 0) {
            return message.channel.send(new Discord.MessageEmbed().setDescription(`:warning: **Filter is activated but no filter words are set**. \n \n **Note**: \n \n To set any, please add some using the following command: \n \`${client.prefix}addfilter <word>\``));
        } else {

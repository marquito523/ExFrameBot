...
const { execute } = require("../Executor/DeleteMessager");
  ...
  if (!message.member.hasPermission('ADMINISTRATOR')) {
    return message.channel.send('You do not have permission to use this command!');
        ...
        const settings = await Guild.findOne({
            ...
            if (!guild) {
                return message.channel.send(new MessageEmbed().setDescription("No Data linked to this server was found. We can not reset data of this server."))
